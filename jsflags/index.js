...
var options = {
	numOfTanks: commandlineArgs.numOfTanks || 4,
	maxTankSpeed: 1,
	friendlyFireSafe: true,
	port: commandlineArgs.port || 8005,
	maxBulletSpeed: 5,
	respawnTime: 10000,
	...
	backgroundSize: 100,
	wallSize: 100,
	AICount: commandlineArgs.AICount || 0
};
...
var map = 'maps/' + (commandlineArgs.map || "one_vs_one.json");
